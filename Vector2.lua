...
local Vector2 = require'middleclass''Vector2'
...
function Vector2.__mul( a, b )
	...
	return Vector2:new( a.x * ( isnum and b or b.x ), a.y * ( isnum and b or b.y ) )
end
...
function Vector2.unit( a )
	local l = #a
	return Vector2:new( a.x / l, a.y / l )
end


function Vector2.sunit( a )
	local l = #a
	a.x, a.y = Vector2:new( a.x / l, a.y / l )
	return a
end

function Vector2.rotate( a, r )
	local c, s = cos(r), sin(r)
	return Vector2:new( c * a.x - s * a.y, s * a.x + c * a.y)
end
...
function Vector2.project( a, b )
	...
	return Vector2:new( s * b.x, s * b.y )
end
...
function Vector2.mirror( a, b )
	...
	return Vector2:new( s * b.x - a.x, s * b.y - a.y )
end
...
if ok then
	...
	local ffimt = ffi.metatype( 'vector2_t', Vector2.__instanceDict )
	function Vector2:allocate()
		return ffimt()
	end
end
